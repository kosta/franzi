...
kafka_message!("FindCoordinator Request (Version: 1) => coordinator_key coordinator_type
...
kafka_message!("FindCoordinator Request (Version: 2) => coordinator_key coordinator_type
  coordinator_key => STRING
  coordinator_type => INT8
...
kafka_message!("FindCoordinator Response (Version: 1) => throttle_time_ms error_code error_message coordinator
...
kafka_message!("FindCoordinator Response (Version: 2) => throttle_time_ms error_code error_message coordinator
  throttle_time_ms => INT32
  error_code => INT16
  error_message => NULLABLE_STRING
  coordinator => node_id host port
