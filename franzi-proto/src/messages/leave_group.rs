kafka_message!("LeaveGroup Request (Version: 0) => group_id member_id
  group_id => STRING
  member_id => STRING
...
kafka_message!("LeaveGroup Request (Version: 1) => group_id member_id
  group_id => STRING
  member_id => STRING
...
kafka_message!("LeaveGroup Request (Version: 2) => group_id member_id
  group_id => STRING
  member_id => STRING
...
kafka_message!("LeaveGroup Response (Version: 0) => error_code
  error_code => INT16
